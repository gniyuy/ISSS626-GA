...
```{r}
popdata <- read_csv("C:/Users/gniyu/OneDrive/Desktop/SMU/Sem 3/ISSS626-G1-Geospatial Analytics and Applications/gniyuy/ISSS626-GA/Hands-on_Ex/Hands-on_Ex01/Data/Aspatial/respopagesextod2011to2020.csv")
```
...
```{r}
write_rds(mpsz_pop2020, "C:/Users/gniyu/OneDrive/Desktop/SMU/Sem 3/ISSS626-G1-Geospatial Analytics and Applications/gniyuy/ISSS626-GA/Hands-on_Ex/Hands-on_Ex02/Data/rds/mpszpop2020.rds")
```
